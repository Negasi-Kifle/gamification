...
from ...Domain.exceptions import InvalidFreebetStateError, FreebetExpiredError
...
class UpdateCasinoFreeBetStatusUseCase:
    ...
    def execute(self, freebet_public_id: str, new_status: CasinoFreeBetStatus) -> CasinoFreeBetResponseDto:
        ...
        if new_status == CasinoFreeBetStatus.ACTIVE:
            ...
            raise InvalidFreebetStateError(f"Cannot manually set status to {new_status.value}")
