...
from bonus.src.Application.use_cases.CreateCasinoFreeBetUsecase import CreateCasinoFreeBetUseCase
from bonus.src.Application.use_cases.UpdateCasinoFreeBetStatusUsecase import UpdateCasinoFreeBetStatusUseCase
from bonus.src.Application.use_cases.GetExpiringCasinoFreebetsUseCase import GetExpiringCasinoFreeBetsUseCase
from bonus.src.Application.dto.request.CasinoCreateFreeBetRequestDto import CasinoCreateFreeBetRequestDto
from bonus.src.Application.dto.response.CasinoFreeBetResponseDto import CasinoFreeBetResponseDto
...
from bonus.src.Domain.repositories.CasinoFreeBetRepositoryInterface import CasinoFreeBetRepository
...
class MockCasinoFreeBetRepository(CasinoFreeBetRepository):
    ...
    def find_active_by_tenant(self, tenant_id: str, current_time: datetime) -> List[CasinoFreeBet]:
        return [
            fb for fb in self.freebets.values()
...
class TestGetExpiringCasinoFreeBetsUseCase:
    ...
    def _create_freebet_in_repo(self, public_id: str, minutes_until_expiry: int, **overrides):
        ...
        created_at = timezone.now() - timedelta(minutes=expiry_minutes - minutes_until_expiry)
    ...
    def test_excludes_already_expired_freebets(self):
        ...
        expiry_minutes = 60
        created_at = timezone.now() - timedelta(minutes=120)  # Created 2h ago, expires in 1h
